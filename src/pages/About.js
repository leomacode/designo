...
function About() {
  ...
  const talentImg = useDynamicImg(talentMobile, talentTablet, talentDesktop);
  const dealImg = useDynamicImg(dealMobile, dealTablet, dealDesktop);
  const bgImg = useDynamicImg(bgMobile, bgDesktop, bgDesktop);
